...
annotate_figure_88_94 <- annotate_figure(combined_plot_88_94, top = "Mean Monthly Nitrate Levels in Watersheds in the Luquillo Experimental Forest Before and After Hurricane Maria",
      fig.lab.pos = "top") +
  theme(plot.title = element_text(hjust = 0.5))


annotate_figure_88_94
```
